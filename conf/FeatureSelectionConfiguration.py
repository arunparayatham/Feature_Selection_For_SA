...
config_object['FeatureSelection'] = {"input_data_path" : '../results/PreProcessing_Results/',
                                     "input_filename" : '_PreProcessed.csv',
                                     ...
                                     "min_df" : 1,
                                     "max_features" : 200,
                                     "output_data_path" : '../results/FeatureSelection_Results/'
                                    }

#Write the above sections to feature_selection.ini file
with open('../conf/feature_selection.ini', 'w') as config_file:
